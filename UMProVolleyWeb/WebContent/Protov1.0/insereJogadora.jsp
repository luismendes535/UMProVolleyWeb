...
<head>
  ...
  <title>Registar novo Atleta</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="">
  <meta name="author" content="">
  
  <script type="javascript/text" src="js/scripts.js" ></script>
...
<h2>
			...
			<form  name="registo" action="jsreg.js" onsubmit="return valida();" >
				<div class="form-group">
					 ...
					 <label for="exampleInputPassword1">Password</label><input type="password" class="form-control" id="exampleInputPassword1" />
                            ...
                            <div class="form-group">
					 <label for="exampleInputEmail1">Nome</label><input type="text" name="nome" class="form-control" id="exampleInputEmail1" />
				</div>
                            <div class="form-group">
